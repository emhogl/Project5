...
void testSLLSetIntArray2() { //I added

        int arr[] = {1, 2, 7, 8}; // this list

        SLLSet listObj2 = SLLSet(arr,4);
        string expectedSet = "1, 2, 7, 8";
        int expectedSize = 4;
        ASSERT_EQUAL(expectedSize,listObj2.getSize());
        ASSERT_EQUAL(expectedSet,listObj2.toString());
	}

void testSLLSetIntArray3() { //I added

        int arr[] = {-1, 0, 7}; // this list

        SLLSet listObj2 = SLLSet(arr,3);
        string expectedSet = "-1, 0, 7";
        int expectedSize = 3;
        ASSERT_EQUAL(expectedSize,listObj2.getSize());
        ASSERT_EQUAL(expectedSet,listObj2.toString());
	}
...
void testCopy2() { //I added

        int arr[] = {0, 1, 2, 3, 7, 8}; // this list
        SLLSet listObj2 =  SLLSet(arr,6);
		SLLSet copied = listObj2.copy();
        copied.add(10);
        string expectedObj2 = "0, 1, 2, 3, 7, 8";
        string expectedCopied = "0, 1, 2, 3, 7, 8, 10";
...
void testCopy3() { //I added

        int arr[] = {-3, -2, -1, 0, 1}; // this list
        SLLSet listObj2 =  SLLSet(arr,5);
		SLLSet copied = listObj2.copy();
        copied.add(-5);
        string expectedObj2 = "-3, -2, -1, 0, 1";
        string expectedCopied = "-5, -3, -2, -1, 0, 1";
        int expectedObj2Size = 5;
        int expectedCopiedSize = 6;
...
void testIsInTrue2() { //I added

    int arr[] = {-3, -1, 0, 1}; // this list
    SLLSet listObj2 =  SLLSet(arr,4);
...
void testIsInFalse2() { //I added

    int arr[] = {1, 2, 3, 7, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);


        int notin = -100; // test isIn
        bool expected = false;
...
void testAdd5() { //I added

    int arr[] = {1, 3, 7, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,4);


        int addsecond = 2;  // test add

        string expectedObj2 = "1, 2, 3, 7, 8";
        int expectedObj2Size = 5;

        listObj2.add(addsecond);
        ASSERT_EQUAL(expectedObj2Size,listObj2.getSize());
        ASSERT_EQUAL(expectedObj2,listObj2.toString());
...
void testAdd6() { //I added

    int arr[] = {1, 3, 7, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,4);


        int addlast = 1000;  // test add

        string expectedObj2 = "1, 3, 7, 8, 1000";
        int expectedObj2Size = 5;
...
void testRemove5() { //I added

    int arr[] = {1, 2, 3, 7, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);

        int removesecond = 2;  // test remove

        //test remove

        listObj2.remove(removesecond);

        string expectedObj2 = "1, 3, 7, 8";
        int expectedObj2Size = 4;
...
void testRemove6() { //I added

    int arr[] = {-1, 2, 3, 7, 10}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);

        int removelast = 10;  // test remove
...
void testUnion5() {//I added
        // test union
    int arr[] = {1, 2, 3, 7}; // this list
    SLLSet listObj2 =  SLLSet(arr,4);
...
void testUnion6() {//I added
        // test union
        SLLSet listObj2 = SLLSet();
...
void testIntersection5() { //I added

    int arr[] = {1, 2, 3, 7}; // this list
    SLLSet listObj2 =  SLLSet(arr,4);


    int inter3[] = {0, 10}; //test intersection

    SLLSet listObj15 = SLLSet(inter3,2);
    SLLSet listObj16 = listObj2.intersection(listObj15);
...
void testIntersection6() { //I added

    int arr[] = {1, 2, 3, 7}; // this list
    SLLSet listObj2 =  SLLSet(arr,4);


    int inter3[] = {1, 2, 3, 7}; //test intersection

    SLLSet listObj15 = SLLSet(inter3,4);
    SLLSet listObj16 = listObj2.intersection(listObj15);
...
void testDifference5() { //I added

	      // parameters inpt here

    int arr[] = {-3, -2, -1}; // this list
    SLLSet listObj2 =  SLLSet(arr,3);
        SLLSet listObj17 = SLLSet();
        SLLSet listObj1000 = listObj17.difference(listObj2);
...
void testDifference6() { //I added

	      // parameters inpt here

    int arr[] = {-2, -1}; // this list
    SLLSet listObj2 =  SLLSet(arr,2);
    int arr2[] = {-2, -1}; // this list
        SLLSet listObj17 =  SLLSet(arr2,2);
...
void testUnionSLLSetArray2() { //I added
...
void testUnionSLLSetArray3() { //I added
        int arr1[] = {0, 9, 15,18,20};
        int arr2[] = {1, 2, 3};
        int arr3[] = {1,2,3};
        SLLSet listObj100 = SLLSet(arr1,5);
        SLLSet listObj99 = SLLSet(arr2,3);
        SLLSet listObj98 = SLLSet(arr3,3);
        SLLSet Array[] = {listObj100, listObj99, listObj98}; // test static SLLSet union(sArray)
         SLLSet listObj23 = SLLSet::setUnion(Array,3);
         string expected = "0, 1, 2, 3, 9, 15, 18, 20";
         int expectedSize = 8;
         ASSERT_EQUAL(expectedSize,listObj23.getSize());
         ASSERT_EQUAL(expected,listObj23.toString());
    }
...
bool runAllTests(int argc, char const *argv[]) {
    ...
    s.push_back(CUTE(testSLLSetIntArray2));
    s.push_back(CUTE(testSLLSetIntArray3));
    ...
    s.push_back(CUTE(testIsInTrue2));
    s.push_back(CUTE(testIsInFalse));
    s.push_back(CUTE(testIsInFalse2));
    ...
    s.push_back(CUTE(testUnionSLLSetArray3));
